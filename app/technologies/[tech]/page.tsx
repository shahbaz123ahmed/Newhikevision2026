...
export default async function TechnologySubPage({ params }: { params: Promise<{ tech: string }> }) {
  ...
  const techMap: Record<string, any> = {
    ...
    acusense: {
      ...
      heroImg: "/navbar/AcuSenseUAE.png",
    ...
    darkfighter: {
      ...
      description1: "Experience superior night surveillance with Hikvision DarkFighter Cameras in UAE, delivering full-color imaging even in near-total darkness. As a trusted Hikvision distributor in Dubai, we provide advanced low-light CCTV solutions across Dubai, Abu Dhabi, Sharjah, and the UAE.",
      ...
      heroImg: "/navbar/HikvisionDarkFighter.png",
  ...
  const techNames: Record<string, { primary: string; secondary: string; badge: string }> = {
    tandemvu: { primary: "TandemVu", secondary: "Technology", badge: "Dual-Lens AI Surveillance Dubai" },
    acusense: { primary: "AcuSense", secondary: "Technology", badge: "AI Human & Vehicle Detection" },
    darkfighter: { primary: "DarkFighter", secondary: "Technology", badge: "Full-Color Night Vision Solutions" },
    colorvu: { primary: "ColorVu", secondary: "Technology", badge: "24/7 Vivid Color Surveillance" },
  };

  const currentTech = techNames[resolvedParams.tech] || {
    primary: resolvedParams.tech.charAt(0).toUpperCase() + resolvedParams.tech.slice(1),
    secondary: "Technology",
    badge: techData.subtitle || "Authorized Hikvision Partner UAE",
  };
    ...
    <div className="min-h-screen bg-brand-light pb-0">
      ...
      <section className="relative mt-[112px] sm:mt-[120px] md:mt-[120px] w-full overflow-hidden bg-[#0c0c0e] h-[72vh] min-h-[560px] max-h-[760px] sm:h-[82vh] md:h-[86vh] lg:h-[88vh] sm:min-h-[680px] md:min-h-[720px] sm:max-h-[960px]">
        <div className="absolute inset-0">
          <img
            ...
            alt={`${currentTech.primary} Background Banner`}
          />
        ...
        <div className="relative h-full w-full max-w-[1700px] mx-auto px-4 sm:px-8 md:px-12 lg:px-14 flex flex-col justify-center items-start text-left pb-8 sm:pb-0 z-10">
          <div className="max-w-xl lg:max-w-2xl text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)]">
            ...
            <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tight mb-2 sm:mb-4 leading-tight sm:leading-[1.05]">
              {currentTech.primary} <span className="text-maroon">{currentTech.secondary}</span>
            </h1>
      ...
      <section className="py-20 bg-brand-light border-y border-gray-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="w-24 h-1 bg-maroon mx-auto rounded-full mb-8" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {techData.features.map((feature: any, index: number) => {
              ...
              return (
                <div key={index} className="bg-brand-light rounded-[30px] p-8 shadow-sm border border-gray-100 hover:shadow-xl hover:border-maroon/30 transition-all duration-300 group flex flex-col h-full">
      ...
      <section className="py-20 bg-brand-light">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="page-hero rounded-[40px] p-12 md:p-16 text-center relative overflow-hidden shadow-2xl">
            {/* Background glowing effects - using maroon and white to avoid black */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-maroon/30 rounded-full blur-3xl mix-blend-screen" />
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
              ...
              <p className="text-white/90 font-bold text-lg md:text-xl max-w-3xl mx-auto mb-10">
                {techData.ctaText}
              </p>

              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
                <button className="bg-white text-maroon px-10 py-5 rounded-full font-black text-sm uppercase tracking-widest hover:bg-rose-50 hover:text-maroon transition-all shadow-xl hover:shadow-2xl active:scale-95 w-full sm:w-auto">
                  Contact Us Today
                </button>
              </div>
          ...
          <section className="py-20 bg-white border-t border-gray-100">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="mt-12 text-center">
                ...
                <Link href="/contact" className="inline-flex items-center gap-3 px-8 py-4 bg-maroon text-white rounded-full font-black uppercase tracking-widest text-xs hover:bg-[#8A1125] transition-all shadow-xl">
